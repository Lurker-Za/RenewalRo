...
enum _sp {
	...
	SP_HEALAP, SP_SKILL_HEALAP, SP_SKILL_BOOST, SP_SKILL_SPLASH_RANGE, SP_SKILL_NO_REQUIRE, SP_SKILL_NO_REQUIRE_ITEM, SP_NO_REQUIRE_AMMO, //[Cydh]
	SP_DOUBLE_CAST_RATE, SP_DOUBLE_CAST_SKILL, SP_SKILL_APUSE, SP_JUMPRANGE, SP_NORMAL_ATK, SP_MULTI_RATE,
	SP_RES_RATIO_ATK_CLASS, SP_SUMMON_SLAVE, SP_MAGICNORMAL,
};

enum e_bonus_noreq : uint16 {
	BONUS_NOREQ_HP     = 0x0001, // 1 - HP cost
	BONUS_NOREQ_MAXHP  = 0x0002, // 2 - MaxHP trigger
	BONUS_NOREQ_SP     = 0x0004, // 4 - SP cost
	BONUS_NOREQ_HPRATE = 0x0008, // 8 - HP rate cost
	BONUS_NOREQ_SPRATE = 0x0010, // 16 - SP rate cost
	BONUS_NOREQ_ZENY   = 0x0020, // 32 - Zeny cost
	BONUS_NOREQ_WEAPON = 0x0040, // 64 - Weapon type
	BONUS_NOREQ_AMMO   = 0x0080, // 128 - Ammo
	BONUS_NOREQ_STATE  = 0x0100, // 256 - Required state
	BONUS_NOREQ_STATUS = 0x0200, // 512 - Required status
	BONUS_NOREQ_SPIRIT = 0x0400, // 1024 - Spirit sphere
	BONUS_NOREQ_ITEM   = 0x0800, // 2048 - Required item
	BONUS_NOREQ_EQUIP  = 0x1000, // 4096 - Required equipment
	BONUS_NOREQ_AP     = 0x2000, // 8192 - AP cost
	BONUS_NOREQ_APRATE = 0x4000, // 16384 - AP rate cost
};
...
typedef s_stall_data	    TBL_STALL;
